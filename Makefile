...
main: main.o controller.o view.o library.o publication.o patron.o dialogs.o main_window.o
	$(CXX) $(CXXFLAGS) -o lms main.o controller.o view.o library.o publication.o patron.o dialogs.o main_window.o `/usr/bin/pkg-config gtkmm-3.0 --cflags --libs`
main_window.o: main_window.cpp main.o *.h
